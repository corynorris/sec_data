defmodule SecData.CompaniesTest do
  ...
  describe "companies" do
    ...
    @valid_attrs %{cik: 42, exchange: "some exchange", industry: "some industry", name: "some name", ticker: "some ticker"}
    @update_attrs %{cik: 43, exchange: "some updated exchange", industry: "some updated industry", name: "some updated name", ticker: "some updated ticker"}
